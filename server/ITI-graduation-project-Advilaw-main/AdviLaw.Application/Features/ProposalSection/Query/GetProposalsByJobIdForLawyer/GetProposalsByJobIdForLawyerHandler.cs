...
{
    public class GetProposalsByJobIdForLawyerHandler(IUnitOfWork unitOfWork, ResponseHandler responseHandler, IMapper mapper) : IRequestHandler<GetProposalsByJobIdForLawyerQuery, Response<ProposalDetails>>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly ResponseHandler _responseHandler = responseHandler;
        private readonly IMapper _mapper = mapper;

        public async Task<Response<ProposalDetails>> Handle(GetProposalsByJobIdForLawyerQuery request, CancellationToken cancellationToken)
        {
            ...
            if (proposal.LawyerId != request.LawyerId)
            {
